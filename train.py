...
# 	if backbone == 'dehazeformer-s':
# 		net = dehazeformer_s()
# 		# net.to(device)
# 		# net = nn.DataParallel(net, device_ids=device_ids)
# 		model_path = os.path.join(model_dir, 'dehazeformer-s.pth')
...
if __name__ == '__main__':
	...
	#model_path = os.path.join(args.pretrained_model, 'dehazeformer-s.pth')
